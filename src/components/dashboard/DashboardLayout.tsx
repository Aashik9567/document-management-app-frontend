...
//       value={{ isCollapsed, isMobileOpen, toggleCollapsed, toggleMobile }}
//     >
...
//         <div
//           className={`hidden lg:block fixed inset-y-0 left-0 z-30 transition-all duration-300 ${sidebarWidth}`}
//         >
