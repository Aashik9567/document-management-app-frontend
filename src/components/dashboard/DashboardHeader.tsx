...
export default function DashboardHeader() {
  ...
  const { toggleCollapsed } = useSidebarStore((state) => state);
  ...
  return (
    <header className="sticky top-0 z-30 bg-white/95 border-b border-gray-200/70 shadow">
      <div className="flex h-20 items-center justify-between px-8">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="relative" ref={dropdownRef}>
            ...
            {/* Dropdown Menu */}
            {isDropdownOpen && (
              <div className="absolute right-0 mt-2 w-80 bg-white rounded-2xl  border border-gray-100 z-50 overflow-hidden">
                {/* User Info Header */}
                    ...
                    <div className="relative">
                      {user?.profileImage ? (
                        <img
                          ...
                          src={
                            "https://document-backend-y4tz.onrender.com/uploads/profilePicture/" +
                            user.profileImage
                          }
                          alt={getDisplayName()}
                        />
