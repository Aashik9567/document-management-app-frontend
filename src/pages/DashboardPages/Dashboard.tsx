...
export default function Dashboard() {
  ...
  const templates = [
    { name: 'NDA Agreement', category: 'Legal', usage: '89%', color: 'from-purple-500 to-indigo-600' },
    { name: 'Employment Contract', category: 'HR', usage: '76%', color: 'from-blue-500 to-cyan-600' },
    { name: 'Service Agreement', category: 'Business', usage: '65%', color: 'from-emerald-500 to-teal-600' },
    { name: 'Offer Letter', category: 'HR', usage: '54%', color: 'from-orange-500 to-red-600' },
  ];
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 border border-white/20 shadow-lg">
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-sm text-gray-600 mt-1">Most popular document templates</p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            {templates.map((template) => (
              <div key={template.name} className="group relative overflow-hidden rounded-xl hover:scale-[1.02] transition-all duration-300">
                ...
                <div className="relative p-6 text-white">
                  ...
                  <div className="flex items-center justify-between">
                    <span className="text-xs text-white/80">{template.usage} usage</span>
